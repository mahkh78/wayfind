              ...
              <div className="shell" style={{ marginTop: 0 }}>
                ...
                <div className="demo-frame" style={{ opacity: 0.7, animation: "pulse 2s infinite ease-in-out" }}>
                  ...
                  <div className="demo-body">
                    <aside className="demo-side" style={{ background: "var(--bg-elev)", minHeight: 400, opacity: 0.5 }} />
                    <div className="demo-content" style={{ background: "var(--bg-elev-2)", minHeight: 400, opacity: 0.5 }} />
                  </div>
                </div>
                <style>{`@keyframes pulse{0%,100%{opacity:.8}50%{opacity:.4}}`}</style>
              </div>
            )}
                ...
                <div style={{ background: "rgba(255,68,68,0.1)", border: "1px solid #ff4444", borderRadius: 12, padding: 24 }}>
                  ...
                  {error.raw && (
                    <details style={{ marginTop: 16 }}>
                      ...
                      <pre style={{ marginTop: 12, padding: 16, background: "#000", borderRadius: 8, fontSize: 12, color: "var(--fg-dim)", overflowX: "auto", whiteSpace: "pre-wrap" }}>{error.raw}</pre>
                    </details>
                  )}
